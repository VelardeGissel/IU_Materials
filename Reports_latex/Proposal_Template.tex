...
\begin{figure}[h]
	...
	\begin{tikzpicture}
		...
		\end{tikzpicture}
	\caption[Graphical Abstract]{Graphical Abstract. Include a graphical abstract of the proposal with the motivation, method, expected results and contributions. Examples can be found in \shortcite{graphicalabstract, VELARDE2024a}. }
	\label{fig:1}
\end{figure}
