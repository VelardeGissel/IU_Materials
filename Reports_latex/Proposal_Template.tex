...
Include a graphical abstract of the proposal including the motivation, method, expected results and contributions, see Figure \ref{fig:1}. Examples can be found in \shortcite{graphicalabstract, VELARDE2024a}. 
\begin{figure}[h]
	\centering
	\begin{tikzpicture}
		...
		\end{tikzpicture}
	\caption[Graphical Abstract]{Graphical Abstract.}
	\label{fig:1}
\end{figure}
