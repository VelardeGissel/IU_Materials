...
\begin{figure}[h]
	...
	\begin{tikzpicture}
		...
		\end{tikzpicture}
	\caption[Graphical Abstract]{Graphical Abstract. It is a graphical representation of the project, including the motivation, method, results and contributions. Examples can be found in \shortcite{graphicalabstract, VELARDE2024a}.}
	\label{fig:gabs}
\end{figure}
\newpage
%--Paper--
...
Finally, this is how you cite online material \shortcite{Stutz2022}, an article \shortcite{lecun1989handwritten}, and a book \shortcite{velarde2023artificial}.\footnote{Please avoid using footnotes.} 
