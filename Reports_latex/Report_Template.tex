...
This is a \LaTeX\  template to present reports. 
...
This section can be used to present a method. In this template, it will be used to present examples to demonstrate how to present material and reference it. Captions of tables and figures should clearly explain the presented content, see for example Table \ref{table:1} and Figure \ref{fig:1}. Next, see an example of a mathematical expression, where $x$ is the input to a Rectified Linear Unit (ReLU) activation function \shortcite{goodfellow2016deep}:
...
\section{RESULTS}
Present results and summarise the findings in tables if necessary, see for example Table \ref{table:1}.
\begin{table}[h!]
\centering
\begin{tabular}{|c c|} 
 \hline
